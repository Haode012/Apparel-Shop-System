...
Public Class DSRCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apparel_Shop_System.DSR(CrystalReport).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDSRCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DSRCrystalReport = New DSRCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
