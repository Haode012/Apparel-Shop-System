...
Public Class ProductCrystalReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Product(CrystalReport).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apparel_Shop_System.Product(CrystalReport).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProductCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProductCrystalReport = New ProductCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
